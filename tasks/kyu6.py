...
def nba_cup(result_sheet, to_find):
    ...
    for act in result_sheet.split(','):
        ...
        first_team, first_score, second_team, second_score = matched.groups()
        first_score, second_score = int(first_score), int(second_score)
        if first_team == to_find:
            score, concede = first_score, second_score
        elif second_team == to_find:
    ...
    return f'{to_find}:W={wins};D={draws};L={losses};Scored={scored};Conceded={conceded};Points={points}'
